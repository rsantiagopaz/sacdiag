qx.Class.define("sacdiag.comp.rpc.Rpc",
{
	...
	construct : function (url, serviceName)
	{
		...
		if (sacdiag.comp.rpc.Rpc.LOADING == null) {
			this.loading = new componente.comp.ui.ramon.image.Loading("sacdiag/loading66.gif");
		} else {
			this.loading = sacdiag.comp.rpc.Rpc.LOADING;
		}
