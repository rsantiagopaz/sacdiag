qx.Class.define("farmacia.comp.rpc.Rpc",
{
	...
	construct : function (url, serviceName)
	{
		...
		if (farmacia.comp.rpc.Rpc.LOADING == null) {
			this.loading = new componente.comp.ui.ramon.image.Loading("farmacia/loading66.gif");
		} else {
			this.loading = farmacia.comp.rpc.Rpc.LOADING;
		}
