qx.Class.define("farmacia.comp.windowWebService",
{
	...
	this.addListenerOnce("appear", function(e){
		loading = new componente.comp.ui.ramon.image.Loading("farmacia/loading66.gif", this);
	...
	btnConsultar.addListener("execute", function(e){
		...
		var rpc = new farmacia.comp.rpc.Rpc("services/", "comp.WebServices");
